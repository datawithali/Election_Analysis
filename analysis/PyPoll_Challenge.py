...
file_to_load = os.path.join("OneDrive", "Desktop", "Election_analysis", "Resources","election_results.csv")
# Add a variable to save the file to a path.
file_to_save = os.path.join("OneDrive", "Desktop","Election_analysis","analysis", "election_analysis.txt")
